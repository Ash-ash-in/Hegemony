...
class ActionContext:
    ...
    from game.old_game.old_agents import Agent, AgentAnswer
    ...
    def compile_options(player: Player, allowed_free: bool, allowed_main: bool) -> dict:
        ...
        from game.old_game.old_rules import FreeAction, MainAction, CheckResponse
    ...
    def action_call(agent: Agent, allowed_main: bool, allowed_free: bool, gamestate: GameState, player: Player):
        ...
        from game.old_game.old_agents import ContextCall
...
class SimpleContext:
    ...
    def spawn_worker_call(gamestate: GameState, player: Player, agent: Agent) -> AgentAnswer:
        ...
        from game.old_game.old_rules import CheckResponse
        from game.old_game.old_agents import ContextCall
